...
describe("nsite deployment workflow", () => {
  test("runs CI for pull requests targeting both default branch names", () => {
  ...
  test("runs after CI succeeds on main/master and skips clearly when secrets are absent", () => {
